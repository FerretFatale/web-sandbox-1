...
- Apply mission context, authority, and prior evidence to avoid shallow or de-scoped outcomes.
...
- `api_get_stale_context_report`
- `api_get_contradiction_candidates`
- `api_get_next_action_freshness_report`
...
- `vault_brain.py`
- `TaskMaster_Brain.py`
- `Toolkit/context_integrity_checker.py`
