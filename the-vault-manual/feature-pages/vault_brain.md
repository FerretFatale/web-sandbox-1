...
- Run mission lifecycle orchestration from intake through approval, execution, and completion.
...
- `vault_brain.py`
- `Toolkit/vault_state_bridge.py`
- `Toolkit/tool_scope_router.py`
