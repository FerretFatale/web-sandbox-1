...
- Classify and relocate incoming data into governed storage categories with traceability.
...
- `api_auto_sort`
- `api_get_storage_destination_suggestion`
- `api_validate_storage_categories`
...
- `Toolkit/advanced_auto_sorter.py`
- `Toolkit/auto_sorter.py`
- `Toolkit/storage_taxonomy.py`
