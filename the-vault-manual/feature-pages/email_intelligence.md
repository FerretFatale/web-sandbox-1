...
- Triage, search, and act on inbox streams with approval gates and auditability.
...
- `api_search_proton_bridge_mail`
- `api_list_proton_mailboxes`
- `api_send_proton_bridge_email`
- `api_proton_execute_unsubscribe`
