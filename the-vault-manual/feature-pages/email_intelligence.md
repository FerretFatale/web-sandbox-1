...
- This page documents production behavior for the Email Intelligence surface in The_Vault, including how the feature is invoked, routed, governed, and validated.
...
- `api_list_email_records`
- `api_generate_email_review_packet`
...
- `Toolkit/email_intelligence.py`
- `Toolkit/email_query.py`
- `Toolkit/email_review_packet_generator.py`
