# Feature: Vault Maintenance (Scheduled and Unscheduled)

## 1) Purpose and outcomes
- This page documents production behavior for the Vault Maintenance (Scheduled and Unscheduled) surface in The_Vault, including how the feature is invoked, routed, governed, and validated.
...
- `docs/manual/MORNING_UPDATE_PROCESS.md`
