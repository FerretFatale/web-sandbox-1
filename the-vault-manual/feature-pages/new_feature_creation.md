...
- Intake gaps, plan new capabilities, and route implementation through governed approval lanes.
...
- `api_log_tool_proposal`
- `api_list_tool_proposals`
- `api_create_work_packet_from_proposal`
...
- `TaskMaster_Brain.py`
- `Toolkit/tool_intake.py`
- `Toolkit/proposal_lifecycle.py`
