...
- This page documents production behavior for the Creation of New Features surface in The_Vault, including how the feature is invoked, routed, governed, and validated.
...
- `TaskMaster_Brain.py`
- `docs/copilot-output/reference/00-authority/external_capability_assimilation_protocol_2026-05-13.md`
