...
- This page documents production behavior for the Eros surface in The_Vault, including how the feature is invoked, routed, governed, and validated.
...
- `api_get_active_eros_context_for_session`
- `api_flush_eros_context_on_session_end`
