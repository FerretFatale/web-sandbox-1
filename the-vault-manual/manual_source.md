...
|---|---|---|
| Risk Register | `docs/copilot-output/reference/10-process-patterns/risk_register.md` | All security findings, credential blockers, and CFM items |
| State Summary | `docs/copilot-output/reference/10-process-patterns/vault_state_summary.md` | Operator-facing summary of current system state |
| Systems Snapshot | `docs/copilot-output/reference/10-process-patterns/vault_systems_snapshot.md` | Feature/status map; generated by `Toolkit/vault_snapshot_generator.py` |
| Persona Audit | `docs/copilot-output/audits/persona_audit.md` | Full 20-persona audit: tools, status, action plan |
| Persona Thread Map | `docs/copilot-output/reference/20-registries-indexes/persona_thread_map.md` | Human-facing chat-thread-to-persona mapping |
...
- **JS-rendered page fetch scaffold** — `api_fetch_url_js_rendered()` exists; Playwright 1.58.0 installed — external navigation requires separate approval

### What is blocked

- **Playwright/Chromium**: installed (1.58.0); Chromium binary available. External navigation requires separate approval.
