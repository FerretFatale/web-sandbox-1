...
|---|---|---|
| Risk Register | `docs/copilot-output/reference/risk_register.md` | All security findings, credential blockers, and CFM items |
| State Summary | `docs/copilot-output/reference/vault_state_summary.md` | Operator-facing summary of current system state |
| Systems Snapshot | `docs/copilot-output/reference/vault_systems_snapshot.md` | Feature/status map; generated by `Toolkit/vault_snapshot_generator.py` |
| Persona Audit | `docs/copilot-output/audits/persona_audit.md` | Full 20-persona audit: tools, status, action plan |
| Persona Thread Map | `docs/copilot-output/reference/persona_thread_map.md` | Human-facing chat-thread-to-persona mapping |
